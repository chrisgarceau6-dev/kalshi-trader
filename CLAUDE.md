...
| `[SHADOW:Z]` vol-normalised distance to strike | Aug 27 (shadow-only, gates nothing) | 1,000 in-band signals AND 400 clusters, ~6-8d | Gates NOTHING. Validates that the live Coinbase feed reproduces the backtested z against BRTI settlement. Bottom-quintile WR below 90.5% AND top-bottom CI excluding zero are BOTH required to proceed |
